...
import getItalianCuisineFoods from '@salesforce/apex/ItalianCuisineController.getItalianCuisineFoods';
import addToCart from '@salesforce/apex/ShoppingCartController.addToCart';

export default class ItalianCuisineLWC extends LightningElement {
    @track foods = [];

...
import getIndianCuisineFoods from '@salesforce/apex/IndianCuisineController.getIndianCuisineFoods';
import addToCart from '@salesforce/apex/ShoppingCartController.addToCart';

export default class IndianCuisineLWC extends LightningElement {
    @track foods = [];
